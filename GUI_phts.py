...
h13.grid(row=8, column=0,columnspan=8,sticky="nsew")
lab8.grid(row=9, column=0, sticky="w")
schoolNames.grid(row=9, column=1, padx=10, pady=15)
lab29.grid(row=9,column=4,sticky="w")
schoolYears.grid(row=9,column=5,padx=10,pady=15)
lab31.grid(row=9,column=6,sticky="w")
schoolJourneys.grid(row=9,column=7,padx=10,pady=15)

lab9.grid(row=10, column=0, sticky="w")
collegeNames.grid(row=10, column=1, padx=10, pady=15)
lab30.grid(row=10,column=4,sticky="w")
education_years.grid(row=10,column=5,padx=10,pady=15)
lab32.grid(row=10,column=6,sticky="w")
education_journeys.grid(row=10,column=7,padx=10,pady=15)

h14.grid(row=11, column=0,columnspan=8,sticky="nsew")
lab21.grid(row=12, column=0, sticky="w")
facebook_links.grid(row=12, column=1, padx=10, pady=15)
lab22.grid(row=12, column=4, sticky="w")
github_links.grid(row=12, column=5, padx=10, pady=15)
lab23.grid(row=12, column=6, sticky="w")
linkedin_links.grid(row=12, column=7, padx=10, pady=15)
lab24.grid(row=13, column=0, sticky="w")
instagram_links.grid(row=13, column=1, padx=10, pady=15)
lab241.grid(row=13, column=4, sticky="w")
location_links.grid(row=13, column=5, padx=10, pady=15)

h15.grid(row=14, column=0,columnspan=8,sticky="nsew")
lab10.grid(row=15, column=0, sticky="w")
roles.grid(row=15, column=1, padx=10, pady=15)
lab11.grid(row=15, column=4, sticky="w")
periodProf1s.grid(row=15, column=5, padx=10, pady=15)
lab16.grid(row=15, column=6, sticky="w")
periodProf2s.grid(row=15, column=7, padx=10, pady=15)

lab12.grid(row=16, column=0, sticky="w")
bulletProf11s.grid(row=16, column=1, padx=10, pady=15)
lab13.grid(row=16, column=4, sticky="w")
bulletProf12s.grid(row=16, column=5, padx=10, pady=15)
lab14.grid(row=16, column=6, sticky="w")
bulletProf13s.grid(row=16, column=7, padx=10, pady=15)
lab15.grid(row=17, column=0, sticky="w")
bulletProf14s.grid(row=17, column=1, padx=10, pady=15)

lab17.grid(row=17, column=4, sticky="w")
bulletProf21s.grid(row=17, column=5, padx=10, pady=15)
lab18.grid(row=17, column=6, sticky="w")
bulletProf22s.grid(row=17, column=7, padx=10, pady=15)
lab19.grid(row=18, column=0, sticky="w")
bulletProf23s.grid(row=18, column=1, padx=10, pady=15)
lab20.grid(row=18, column=4, sticky="w")
bulletProf24s.grid(row=18, column=5, padx=10, pady=15)
lab21.grid(row=18, column=6, sticky="w")
summarys.grid(row=18, column=7, padx=10, pady=15)

h16.grid(row=19, column=0,columnspan=8,sticky="nsew")
lab34.grid(row=21,column=0,sticky="w")
s1names.grid(row=21,column=1,padx=10,pady=15)

lab35.grid(row=22,column=0,sticky="w")
s2names.grid(row=22,column=1,padx=10,pady=15)
lab36.grid(row=23,column=0,sticky="w")
s3names.grid(row=23,column=1,padx=10,pady=15)
lab37.grid(row=24,column=0,sticky="w")
s4names.grid(row=24,column=1,padx=10,pady=15)
lab38.grid(row=25,column=0,sticky="w")
s5names.grid(row=25,column=1,padx=10,pady=15)
lab39.grid(row=26,column=0,sticky="w")
s6names.grid(row=26,column=1,padx=10,pady=15)
lab40.grid(row=27,column=0,sticky="w")
s7names.grid(row=27,column=1,padx=10,pady=15)
lab41.grid(row=28,column=0,sticky="w")
s8names.grid(row=28,column=1,padx=10,pady=15)

lab351.grid(row=21,column=4)
s1vals.grid(row=21,column=5,padx=10,pady=15)
lab352.grid(row=22,column=4)
s2vals.grid(row=22,column=5,padx=10,pady=15)
